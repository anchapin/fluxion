//! Cross-Platform Determinism Test for Case 800 (Heat pump, single-stage)
//!
//! Annual hash for the Case 800 spec; emits `DETERMINISM_CASE800_VALUES|...`
//! markers that `.github/workflows/determinism_check.yml` aggregates into
//! the Fluxion Determinism Gate (issue #1351 / issue #3583).
//!
//! Mirrors `tests/case_900_determinism.rs` and `tests/case_800_spec.rs`
//! (HVAC equipment determinism contract).
