//! Cross-Platform Determinism Test for Case 810 (Comprehensive HVAC equipment)
//!
//! Annual hash for the Case 810 spec; emits `DETERMINISM_CASE810_VALUES|...`
