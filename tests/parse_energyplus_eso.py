        ...
        with open(self.filepath, "r") as f:
            for line in f:
                ...
                if line.startswith("Program Version"):
                    ...
                    var_field_with_units = line[
                        second_comma + 1 :
                    ]  # Everything after 2nd comma
                    ...
                    self.variables[var_id] = {"name": var_name, "units": units}
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print(
            "Example: python parse_energyplus_eso.py benchmarks/outputs/bestest_gsr/case_900/run/eplusout.eso"
        )
        sys.exit(1)
