...
**Data source as of:** 2026-08-16 08:30 UTC  
...
| Mean Absolute Error (MAE) | **51.91%** | ≤ 50% (`validation.max_mae`) | ❌ Fail | `docs/ASHRAE140_RESULTS.md` |
...
| Validation-suite throughput | 12.26 cases/sec | (informational) | ℹ️ | `docs/ASHRAE140_RESULTS.md` |
| Max single-case deviation | 470.11% | (ref: `individual.max_deviation` = 100%) | ℹ️ | `docs/ASHRAE140_RESULTS.md` |

## ASHRAE 140 Pass Rate

- **Overall (metric-level):** 12.5% — 8 PASS / 7 WARN / 49 FAIL of 64 results. Below the 60% gate.
...
- **Validation-suite throughput:** 12.26 cases/sec — informational only; this is the test-runner cadence, not the BatchOracle benchmark (source: `docs/ASHRAE140_RESULTS.md`).

## MAE vs Budget

- **Gate:** ≤ **50%** (`validation.max_mae`).
- **Current:** **51.91%** — Over budget by +1.91 pp. Max single-case deviation 470.11%.
