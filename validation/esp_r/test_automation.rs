...
pub fn run_cross_validation_test(
    ...
    let fluxion_results = run_fluxion_simulation(&config.fluxion_config)?;
...
) -> Result<crate::validation::ValidationResults, Box<dyn Error>> {
...
mod tests {
    ...
    fn test_test_config_serialization() {
        let config = EspRTestConfig {
            ...
            fluxion_config: crate::simulation::SimulationConfig::default(),
            tolerance: 0.5,
