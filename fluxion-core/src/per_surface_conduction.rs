...
//!
//! As of #2462, this module was hoisted out of `fluxion::sim::per_surface_conduction`
//! into the workspace leaf crate `fluxion_core::per_surface_conduction` so the
//! `physics ↔ sim` module cycle (Issue #2462) can close. The original
//! `src/sim/per_surface_conduction.rs` is now a thin re-export shim.
