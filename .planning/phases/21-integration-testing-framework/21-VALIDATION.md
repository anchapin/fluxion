...
- [x] `src/testing/integration/fixtures.rs` — stubs for BuildingScenario builder
- [x] `src/testing/integration/wiring.rs` — stubs for WiringTracer
- [x] `src/testing/integration/scenarios.rs` — stubs for pre-built scenarios
- [x] `tests/integration/test_e2e_scenarios.rs` — stubs for E2E scenarios
- [x] `tests/integration/test_wiring.rs` — stubs for wiring validation
- [x] `tests/integration/test_batch_oracle.rs` — stubs for BatchOracle tests
- [x] `tests/integration/test_cli.rs` — stubs for CLI tests
- [x] `tests/integration/test_pyo3_bindings.rs` — stubs for PyO3 binding tests
- [x] `tests/integration/test_numpy_arrays.py` — stubs for NumPy array validation
- [x] `tests/integration/test_ashrae_140_regression.rs` — stubs for ASHRAE 140 regression test
- [x] `tests/data/v0.4/`, `tests/data/v0.5/`, `tests/data/latest` — test data directories
