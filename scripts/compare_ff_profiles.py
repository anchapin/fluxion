...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Analyze free-float temperature profiles.')
    parser.add_argument('--csv', type=str, default='case_900ff_profile_hourly.csv', help='Path to CSV file')
