...
def sweep_h_ms_coeff():
    ...
    for h_ms_coeff in sweep_values:
        ...
        # Update the source
        with open(
            "/home/alex/Projects/fluxion/src/sim/thermal_model_core.rs", "r"
        ) as f:
            content = f.read()
        ...
        with open(
            "/home/alex/Projects/fluxion/src/sim/thermal_model_core.rs", "w"
        ) as f:
            f.write(new_content)
        ...
        if min_temp is not None:
            ...
            print(
                f"  Min={min_temp:.2f}°C {'✅' if min_pass else '❌'} Max={max_temp:.2f}°C {'✅' if max_pass else '❌'} {status}"
            )
        else:
    ...
    print("\n=== Results ===")
    print(
        f"{'h_ms_coeff':>12} {'Min Temp':>10} {'Max Temp':>10} {'Min OK':>8} {'Max OK':>8} {'Status':>10}"
    )
    print("-" * 60)
    ...
    for r in results:
        ...
        print(
            f"{r['h_ms_coeff']:>12.1f} {r['min_temp']:>10.2f} {r['max_temp']:>10.2f} {'✅':>8} {'✅' if r['max_pass'] else '❌':>8} {status:>10}"
        )
    ...
    if passing:
        ...
        def score(r):
            ...
            max_mid = (
                MAX_TEMP_MIN + MAX_TEMP_MAX
            ) / 2  # midpoint of acceptable max range
