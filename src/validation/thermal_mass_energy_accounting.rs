...
//!
//! ```rust
//! // `calculate_mass_energy` requires a `ThermalModel` constructed via
//! // `from_spec_with_selector`. See issue #3287 for the deprecation trail.
//! use fluxion::validation::thermal_mass_energy_accounting::calculate_mass_energy;
