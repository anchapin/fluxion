...
//!
//! // The helper formats whatever bytes you hand it — pass a real digest,
//! // not raw message bytes (an empty byte slice hashes to the empty hex
//! // string).
//! assert_eq!(
//!     sha256_hex([0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14, 0x9a, 0xfb,
