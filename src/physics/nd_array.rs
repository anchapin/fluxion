...
impl<'b> Add<&'b NDArrayField> for &NDArrayField {
...
impl<'b> Sub<&'b NDArrayField> for &NDArrayField {
    type Output = NDArrayField;
...
impl<'b> Mul<&'b NDArrayField> for &NDArrayField {
    type Output = NDArrayField;
...
impl<'b> Div<&'b NDArrayField> for &NDArrayField {
    type Output = NDArrayField;
