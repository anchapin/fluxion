...
| Metric | Value |
|--------|-------|
| Total Validation Duration | 2.12 seconds |
...
**Affected metrics:** 620 - Peak Cooling Load (kW), 640 - Peak Cooling Load (kW), 630 - Peak Cooling Load (kW), 610 - Peak Cooling Load (kW), 650 - Peak Cooling Load (kW) |
**Count:** 5 metrics

### 5R1C Model Limitation (Accepted)

**Affected metrics:** 930 - Annual Cooling Energy (MWh), 950 - Annual Cooling Energy (MWh), 900 - Annual Cooling Energy (MWh), 920 - Annual Heating Energy (MWh), 930 - Annual Heating Energy (MWh), 910 - Annual Cooling Energy (MWh), 940 - Annual Heating Energy (MWh), 900 - Annual Heating Energy (MWh), 910 - Annual Heating Energy (MWh), 950 - Annual Heating Energy (MWh), 920 - Annual Cooling Energy (MWh) |
**Count:** 11 metrics

### Unknown/Unclassified

**Affected metrics:** 610 - Annual Cooling Energy (MWh), 940 - Peak Heating Load (kW), 650 - Peak Heating Load (kW), 920 - Peak Heating Load (kW), 195 - Annual Heating Energy (MWh), 620 - Annual Heating Energy (MWh), 650 - Annual Cooling Energy (MWh), 600FF - Maximum Free-Floating Temperature (°C), 650FF - Maximum Free-Floating Temperature (°C), 610 - Annual Heating Energy (MWh), 960 - Annual Heating Energy (MWh), 650 - Annual Heating Energy (MWh), 940 - Peak Cooling Load (kW), 610 - Peak Heating Load (kW), 195 - Peak Heating Load (kW), 640 - Annual Cooling Energy (MWh), 640 - Annual Heating Energy (MWh), 960 - Peak Cooling Load (kW), 600FF - Minimum Free-Floating Temperature (°C), 630 - Annual Heating Energy (MWh), 950 - Peak Heating Load (kW), 910 - Peak Heating Load (kW), 930 - Peak Cooling Load (kW), 195 - Peak Cooling Load (kW), 630 - Annual Cooling Energy (MWh), 620 - Annual Cooling Energy (MWh), 930 - Peak Heating Load (kW), 910 - Peak Cooling Load (kW), 620 - Peak Heating Load (kW), 640 - Peak Heating Load (kW), 650FF - Minimum Free-Floating Temperature (°C), 600 - Peak Heating Load (kW), 900 - Peak Cooling Load (kW), 950 - Peak Cooling Load (kW), 920 - Peak Cooling Load (kW), 630 - Peak Heating Load (kW), 195 - Annual Cooling Energy (MWh), 960 - Peak Heating Load (kW) |
**Count:** 38 metrics
