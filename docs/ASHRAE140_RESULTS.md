...
| ASHRAE 140 reference set | `src/validation/benchmark.rs::get_benchmark_data()` snapshot pre-#1408 reconciliation (Case 900 annual cooling 2.13-3.67 MWh; post-#1408 the Case 900 reference is the same band but the **Case 600 reference** widened from 5.50-7.50 MWh heating to the post-#1270 4.36-5.79 MWh band) |
...
**pre-#1270** (5.5-7.5 MWh heating vs current 4.36-5.79 MWh), and (c) the
