...
| Metric | Value |
|--------|-------|
| Total Validation Duration | 1.12 seconds |
| Throughput | 18.75 cases/sec |
| Total Cases | 21 |
...
**Affected metrics:** 910 - Annual Heating Energy (kWh), 900 - Annual Heating Energy (kWh), 930 - Annual Cooling Energy (kWh), 900 - Annual Cooling Energy (kWh), 970 - Annual Cooling Energy (kWh), 970 - Annual Heating Energy (kWh), 920 - Annual Heating Energy (kWh), 920 - Annual Cooling Energy (kWh), 910 - Annual Cooling Energy (kWh), 940 - Annual Cooling Energy (kWh) |
**Count:** 10 metrics

### Thermal Mass Dynamics

**Affected metrics:** 940 - Peak Cooling Load (kW), 910 - Peak Cooling Load (kW), 930 - Peak Heating Load (kW), 970 - Peak Heating Load (kW), 910 - Peak Heating Load (kW), 900 - Peak Heating Load (kW), 950FF - Minimum Free-Floating Temperature (°C), 950 - Peak Heating Load (kW), 900FF - Minimum Free-Floating Temperature (°C), 960 - Peak Heating Load (kW), 950FF - Maximum Free-Floating Temperature (°C) |
**Count:** 11 metrics

### Unknown/Unclassified

**Affected metrics:** 195 - Annual Heating Energy (kWh), 640 - Annual Heating Energy (kWh), 195 - Annual Cooling Energy (kWh), 930 - Annual Heating Energy (kWh), 900 - Peak Cooling Load (kW), 950 - Annual Heating Energy (kWh), 940 - Annual Heating Energy (kWh), 920 - Peak Cooling Load (kW), 950 - Annual Cooling Energy (kWh), 800 - Peak Heating Load (kW) |
**Count:** 10 metrics

### HVAC Load Calculation

**Affected metrics:** 810 - Annual Cooling Energy (kWh), 600 - Peak Heating Load (kW), 620 - Peak Heating Load (kW), 195 - Peak Heating Load (kW), 630 - Peak Cooling Load (kW), 800 - Annual Cooling Energy (kWh), 195 - Peak Cooling Load (kW), 610 - Peak Cooling Load (kW), 650 - Peak Cooling Load (kW), 810 - Annual Heating Energy (kWh), 640 - Peak Heating Load (kW) |
**Count:** 11 metrics

### Solar Gain Calculations

**Affected metrics:** 650 - Annual Cooling Energy (kWh), 810 - Peak Cooling Load (kW), 930 - Peak Cooling Load (kW), 800 - Peak Cooling Load (kW), 610 - Annual Cooling Energy (kWh), 640 - Annual Cooling Energy (kWh), 600FF - Maximum Free-Floating Temperature (°C), 650FF - Maximum Free-Floating Temperature (°C), 600 - Annual Cooling Energy (kWh), 960 - Peak Cooling Load (kW), 600 - Peak Cooling Load (kW), 970 - Peak Cooling Load (kW), 950 - Peak Cooling Load (kW), 620 - Annual Cooling Energy (kWh), 650FF - Minimum Free-Floating Temperature (°C) |
**Count:** 15 metrics
