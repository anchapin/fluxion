...
| Metric | Value |
|--------|-------|
| Total Validation Duration | 0.77 seconds |
| Throughput | 23.50 cases/sec |
| Total Cases | 18 |
...
**Affected metrics:** 650 - Peak Cooling Load (kW), 640 - Peak Cooling Load (kW), 620 - Peak Cooling Load (kW), 610 - Peak Cooling Load (kW), 630 - Peak Cooling Load (kW) |
**Count:** 5 metrics

### 5R1C Model Limitation (Accepted)

**Affected metrics:** 930 - Annual Heating Energy (MWh), 940 - Annual Heating Energy (MWh), 930 - Annual Cooling Energy (MWh), 950 - Annual Heating Energy (MWh), 900 - Annual Heating Energy (MWh), 910 - Annual Cooling Energy (MWh), 920 - Annual Cooling Energy (MWh), 920 - Annual Heating Energy (MWh), 950 - Annual Cooling Energy (MWh), 910 - Annual Heating Energy (MWh), 900 - Annual Cooling Energy (MWh) |
**Count:** 11 metrics
