...
*Generated: 2026-04-14 00:39 UTC*
...
| Metric | Value |
|--------|-------|
| Total Validation Duration | 0.78 seconds |
| Throughput | 23.08 cases/sec |
| Total Cases | 18 |
...
|------|--------|------------|-------|--------|---------|
| 600 | Annual Heating Energy (MWh) | WARN (6.49) | - | - | FAIL |
| 600 | Annual Cooling Energy (MWh) | PASS (9.25) | - | - | PASS |
| 600 | Peak Heating Load (kW) | WARN (3.31) | - | - | FAIL |
| 600 | Peak Cooling Load (kW) | PASS (5.63) | - | - | PASS |
...
**Affected metrics:** 620 - Peak Cooling Load (kW), 630 - Peak Cooling Load (kW), 650 - Peak Cooling Load (kW), 640 - Peak Cooling Load (kW), 610 - Peak Cooling Load (kW) |
**Count:** 5 metrics
...
**Affected metrics:** 640 - Annual Cooling Energy (MWh), 650 - Annual Cooling Energy (MWh), 620 - Annual Heating Energy (MWh), 650 - Annual Heating Energy (MWh), 600FF - Minimum Free-Floating Temperature (°C), 940 - Peak Heating Load (kW), 920 - Peak Heating Load (kW), 195 - Annual Cooling Energy (MWh), 600FF - Maximum Free-Floating Temperature (°C), 950 - Peak Heating Load (kW), 600 - Peak Heating Load (kW), 195 - Annual Heating Energy (MWh), 195 - Peak Heating Load (kW), 610 - Annual Cooling Energy (MWh), 195 - Peak Cooling Load (kW), 910 - Peak Heating Load (kW), 920 - Peak Cooling Load (kW), 950 - Peak Cooling Load (kW), 650 - Peak Heating Load (kW), 620 - Peak Heating Load (kW), 960 - Annual Heating Energy (MWh), 640 - Peak Heating Load (kW), 900 - Peak Cooling Load (kW), 930 - Peak Cooling Load (kW), 620 - Annual Cooling Energy (MWh), 640 - Annual Heating Energy (MWh), 930 - Peak Heating Load (kW), 960 - Peak Heating Load (kW), 630 - Peak Heating Load (kW), 630 - Annual Heating Energy (MWh), 650FF - Minimum Free-Floating Temperature (°C), 960 - Peak Cooling Load (kW), 610 - Annual Heating Energy (MWh), 910 - Peak Cooling Load (kW), 940 - Peak Cooling Load (kW), 630 - Annual Cooling Energy (MWh), 650FF - Maximum Free-Floating Temperature (°C), 610 - Peak Heating Load (kW), 600 - Annual Heating Energy (MWh) |
**Count:** 39 metrics

### 5R1C Model Limitation (Accepted)

**Affected metrics:** 940 - Annual Heating Energy (MWh), 920 - Annual Heating Energy (MWh), 930 - Annual Cooling Energy (MWh), 950 - Annual Cooling Energy (MWh), 900 - Annual Heating Energy (MWh), 950 - Annual Heating Energy (MWh), 940 - Annual Cooling Energy (MWh), 910 - Annual Heating Energy (MWh), 900 - Annual Cooling Energy (MWh), 920 - Annual Cooling Energy (MWh), 910 - Annual Cooling Energy (MWh), 930 - Annual Heating Energy (MWh) |
**Count:** 12 metrics
