...
*Generated: 2026-09-21 23:04 UTC*
...
| Metric | Value |
|--------|-------|
| Total Validation Duration | 6.13 seconds |
| Throughput | 3.42 cases/sec |
| Total Cases | 21 |
...
| 620 | 5948.61 kWh (Ref: 4094.00-4719.00) | 2361.26 kWh (Ref: 3841.00-4404.00) | 4.49 kW (Ref: 3.04-3.38) | 2.98 kW (Ref: 3.96-4.80) | ❌ FAIL |
...
| 650 | 0.00 kWh (Ref: 0.00-0.00) | 2463.16 kWh (Ref: 4820.00-7060.00) | 0.00 kW (Ref: 0.00-0.00) | 3.35 kW (Ref: 1.90-2.50) | ❌ FAIL |
...
| 950 | 0.00 kWh (Ref: 0.00-0.00) | 361.10 kWh (Ref: 390.00-920.00) | 0.00 kW (Ref: 0.00-0.00) | 0.82 kW (Ref: 0.70-0.90) | ❌ FAIL |
...
| 650FF | -23.75°C (Ref: -23.00--21.00) | 52.44°C (Ref: 63.20-73.50) | ❌ FAIL |
| 900FF | -6.65°C (Ref: -6.40--1.60) | 39.83°C (Ref: 41.80-46.40) | ❌ FAIL |
| 950FF | -21.67°C (Ref: -20.20--17.80) | 36.58°C (Ref: 35.50-38.50) | ❌ FAIL |
...
| 950 | Annual Cooling Energy (kWh) | FAIL (361.10) | - | - | FAIL |
| 950 | Peak Heating Load (kW) | FAIL (0.00) | - | - | FAIL |
| 950 | Peak Cooling Load (kW) | FAIL (0.82) | - | - | FAIL |
...
**Affected metrics:** 970 - Annual Heating Energy (kWh), 900 - Annual Cooling Energy (kWh), 910 - Annual Cooling Energy (kWh), 970 - Annual Cooling Energy (kWh), 920 - Annual Cooling Energy (kWh), 920 - Annual Heating Energy (kWh), 900 - Annual Heating Energy (kWh), 930 - Annual Cooling Energy (kWh), 910 - Annual Heating Energy (kWh), 940 - Annual Cooling Energy (kWh) |
**Count:** 10 metrics

### Thermal Mass Dynamics

**Affected metrics:** 900 - Peak Heating Load (kW), 900FF - Minimum Free-Floating Temperature (°C), 950FF - Minimum Free-Floating Temperature (°C), 970 - Peak Heating Load (kW), 950 - Peak Heating Load (kW), 960 - Peak Heating Load (kW), 910 - Peak Cooling Load (kW), 930 - Peak Heating Load (kW), 940 - Peak Cooling Load (kW), 910 - Peak Heating Load (kW) |
**Count:** 10 metrics

### Unknown/Unclassified

**Affected metrics:** 940 - Annual Heating Energy (kWh), 620 - Annual Heating Energy (kWh), 195 - Annual Cooling Energy (kWh), 930 - Annual Heating Energy (kWh), 640 - Annual Heating Energy (kWh), 950 - Annual Heating Energy (kWh), 950 - Annual Cooling Energy (kWh), 920 - Peak Cooling Load (kW), 900 - Peak Cooling Load (kW), 800 - Peak Heating Load (kW) |
**Count:** 10 metrics

### Solar Gain Calculations

**Affected metrics:** 650 - Annual Cooling Energy (kWh), 650FF - Maximum Free-Floating Temperature (°C), 970 - Peak Cooling Load (kW), 930 - Peak Cooling Load (kW), 810 - Peak Cooling Load (kW), 640 - Annual Cooling Energy (kWh), 650FF - Minimum Free-Floating Temperature (°C), 600 - Peak Cooling Load (kW), 960 - Peak Cooling Load (kW), 195 - Annual Heating Energy (kWh), 600FF - Maximum Free-Floating Temperature (°C), 950 - Peak Cooling Load (kW), 600 - Annual Cooling Energy (kWh), 620 - Peak Cooling Load (kW), 610 - Annual Cooling Energy (kWh), 620 - Annual Cooling Energy (kWh), 800 - Peak Cooling Load (kW) |
**Count:** 17 metrics
...
**Affected metrics:** 810 - Annual Cooling Energy (kWh), 640 - Peak Heating Load (kW), 810 - Annual Heating Energy (kWh), 800 - Annual Cooling Energy (kWh), 195 - Peak Cooling Load (kW), 620 - Peak Heating Load (kW), 610 - Peak Cooling Load (kW), 195 - Peak Heating Load (kW), 630 - Peak Cooling Load (kW), 600 - Peak Heating Load (kW), 650 - Peak Cooling Load (kW) |
**Count:** 11 metrics
